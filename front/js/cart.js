...
const createCart = searchInLocalStorage.forEach((i) => {
  ...
  .then((data) => {
    ...
    //calcul des la somme des prix contenu dans le tableau "priceProduct" et insertion dans le DOM
    totalPrice.textContent = eval(priceProduct.join("+"));
  })
...
//le champs doit contenir une suite de lettre, de chiffre, de "-" ou "_", suivi d'un @ suivi d"une suite de lettre et de chiffre de minimum 2 caractère, suivi d"un ".", suivi d"une suite de lettre compris entre 2 et 5 caractère
var regMail = /^[a-zA-Z0-9_-]+@[a-zA-Z0-9-]{2,}[.][a-zA-Z]{2,4}$/
